...
cumulative_rewards50 = dyna_Q(50, start, target,
                              alpha, gamma, epsilon,
                              max_time, runs)

cumulative_rewards50_plus = dyna_Q_plus(50, 1e-3, start, target,
                                        alpha, gamma, epsilon,
                                        max_time, runs)
